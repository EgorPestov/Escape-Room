...
export const getActiveSortByGenreType = (state: State): string => state[NameSpace.Quests].activeSortByGenreType;
export const getActiveSortByLevelType = (state: State): string => state[NameSpace.Quests].activeSortByLevelType;
